...
\begin{document}
        ...
        En appuyant sur un site verouillé, une fenêtre de dialogue s'ouvre avec le prix du déblocage affiché (voir figure \ref{fig:unlockSite}).
        \begin{figure}[H]
        ...
        Il est également possible d'améliorer une centrale électrique pour qu'elle produise plus (ce qui aura comme conséquence qu'elle polluera également plus). (voir figure \ref{fig:upgradePlant}).
        \begin{figure}[H]
        ...
        Voyons maintenant comment concrètement jouer au jeu.
