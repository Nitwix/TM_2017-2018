...
globReg.init = function(){
    ...
    globals.regions.europe = new Region("europe", 6,
        ...
        [[273, 239], [240,184], [349,257], [521, 244], [253, 355], [454, 363], [434, 119]]); //voir définition dans classes/regions.js
    ...
    globals.regions.southAmerica = new Region("southAmerica", 3,
        ...
        [[432, 110], [535, 179], [409, 238], [398, 347]]);

    globals.regions.northAmerica = new Region("northAmerica", 3,
        [[111, 107], [383, 76], [268, 195], [158, 197]],
        [[200, 132], [400, 350], [484, 273], [417, 286], [424, 207], [278, 239]]);

    globals.regions.asia = new Region("asia", 3,
        [[444,131], [457, 97], [712, 89], [703, 207], [523, 224]],
        [[583, 134], [507, 305], [445, 373], [392, 297], [634, 258], [304, 355], [204, 181]]);

    globals.regions.oceania = new Region("oceania", 4,
        [[523, 229], [700, 212], [708, 312], [511, 307]],
